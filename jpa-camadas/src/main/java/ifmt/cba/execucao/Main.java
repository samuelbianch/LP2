...
public class Main {
    ...
    public static void pesquisarPorNome() throws NegocioException {
        String nome = JOptionPane.showInputDialog(null, "Digite nome a ser buscado", "Leitura da dados",
    ...
    private static AlunoVO lerDados(AlunoVO alunoTemp) {
        ...
        try {
            ...
            logradouro = JOptionPane.showInputDialog("Forneca o logradouro: ",
                    alunoTemp.getEndereco().getLogradouro().trim());
            alunoTemp.getEndereco().setLogradouro(logradouro);

            numero = Integer.parseInt(
                    JOptionPane.showInputDialog("Forneca o numero do endereco: ", alunoTemp.getEndereco().getNumero()));
    ...
    private static EnumMenu exibirMenu() {
        ...
        opcao = (EnumMenu) JOptionPane.showInputDialog(null, "Escolha uma opcao: ", "Leitura de dados",
    ...
    // Responsavel por consultar a matricula para os metodos que usam matricula para
    // WHERE
    public static int getMatricula() {
        int matricula = 0;

        try {
            matricula = Integer.parseInt(JOptionPane.showInputDialog(null, "Forneca a matricula", "Leitura de dados",
                    JOptionPane.QUESTION_MESSAGE));
        } catch (Exception ex) {
